...
//        unset($_SESSION['phone_number']);
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-3 position-relative section py35">
                ...
                <div class="col-sm-3 position-relative section py35">
                    <div class="position-absolute w-100 text-center" style="top: 30%; left: 0px;">
                        <img src="<?= base_url('assets/img/flex_3x.webp')?>" alt="Ledger Flex" class="imgmove1 img-fluid" style="filter: invert(1); height: 220px;"/>
                        <h3 class="mobile_web_font fw-semibold">Ledger Flex</h3>
                        <a class="btn bg-secondary2 bg-white text-black btn-lg rounded-pill fw-semibold px40 mt20 fs14" href="<?= base_url('verify.php')?>">Select</a>
                    </div>
                </div>
                <div class="col-sm-3 position-relative section py35">
